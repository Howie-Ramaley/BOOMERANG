// Credit to SkorpionX on the Unity Forums
// https://forum.unity.com/threads/export-full-scene-as-image.496232/
...
public class ScreenShotMaker : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        System.IO.File.WriteAllBytes(path + @"\ScreenShotTaken.png", bytes);
